...
String shareUrlSublist='';

class ShareDialogSublist extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Dialog(
      ...
      child: dialogContent(context,shareUrlSublist),
    );
  }
  ...
  Widget buildOption(BuildContext context, String text, IconData icon, Color color,String url) {
    ShareOptionsProviderSublist shareOptionsProvider = Provider.of<ShareOptionsProviderSublist>(context);
...
void showCustomDialogSublist(BuildContext context) {
  showDialog(
    context: context,
    builder: (BuildContext context) {
      return ShareDialogSublist();
    },
  );
}