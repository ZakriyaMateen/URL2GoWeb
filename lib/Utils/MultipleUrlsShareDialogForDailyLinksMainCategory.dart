...
class MultipleUrlsShareDialogForDailyLinksMainCategory extends StatelessWidget {
  @override
  ...
  Widget buildOption(BuildContext context, String text, IconData icon, Color color,String url) {
    ShareOptionsDailyLinksMainCategoryProvider shareOptionsProvider = Provider.of<ShareOptionsDailyLinksMainCategoryProvider>(context);
    return Padding(
...
void showCustomDialogUrlsMainCategory(BuildContext context) {
  showDialog(
    context: context,
    builder: (BuildContext context) {
      return MultipleUrlsShareDialogForDailyLinksMainCategory();
    },
  );
}