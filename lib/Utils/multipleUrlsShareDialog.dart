...
class MultipleUrlsShareDialog extends StatelessWidget {
  @override
  ...
  Widget buildOption(BuildContext context, String text, IconData icon, Color color,String url) {
    ShareOptionsDailyLinksProvider shareOptionsProvider = Provider.of<ShareOptionsDailyLinksProvider>(context);
    return Padding(
...
void showCustomDialogUrls(BuildContext context) {
  showDialog(
    context: context,
    builder: (BuildContext context) {
      return MultipleUrlsShareDialog();
    },
  );
}