...
Widget recentLinksMainCategory(double w,double h,String roll,CategoryProvider categoryProvider,FontSizeProvider fontSizeProvider, String profileImageUrl,String firstName,String lastName,String corporationEmail){
  return Padding(
        ...
        children: [
          Row(
            ...
            children: [
              ...
              textRubik('Recent links', textColor, w500, size18 * fontSizeProvider.fontSizeMultiplier),
            ],
          ),
          SizedBox(
            height: 10,
                                              ...
                                              context) {
                                                return AlertDialog(
                                                  ...
                                                  content: textRubik(
                                                      ...
                                                      FontWeight
                                                          .w400,
                                                      size13 * fontSizeProvider.fontSizeMultiplier),
                                                  actions: [
                                                    TextButton(
                                                      onPressed:
                                                          () {
